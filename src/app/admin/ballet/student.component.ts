                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <div class="col-sm-6">
                       ...
                       <div class="col-sm-6">
                            <div  class="form-group">
                            <label *ngIf="duration != 'NA'" for="DURATION" class="col-sm-4 control-label" >Duration</label>
                            <div *ngIf="duration != 'NA'" class="col-sm-2">
...
export class StudentComponent {
    ...
    constructor(
        private router: Router, private _gridService : GridService,
