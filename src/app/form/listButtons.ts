...
@Component({
    ...
    template: `
     <div *ngIf="display" style="text-align:center;">
...
export class ListButtonsComponent {
    ...
    ngOnInit() {
        console.log("false au départ: " +this.display)
        ...
        if (this.objStep.conditions.length > 0){
            console.log("IL Y A AU MOINS UNE CONDITION")
            this.listOfElements = this.objStep.configuration.list
 ...
 console.log(valueCondition)
            ...
            if (typeof this._formService.arraySteps.find(x => x[keyCondition] === valueCondition) != 'undefined'){
                ...
                if (typeof this.objStep.conditions[0][1] != 'undefined'){
        ...
        this.currentList_es = this.listOfElements;
        this.currentList_en = this.listOfElements;
        this.currentList_fr = this.listOfElements;
        this.currentList_nl = this.listOfElements;
        console.log("AFFICHER audition" + this.objStep.name + " : " +  this.display)
